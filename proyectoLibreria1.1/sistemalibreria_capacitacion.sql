...
CREATE TABLE `capacitacion` (
  ...
  PRIMARY KEY (`idEmpleadoBodega`,`capacitacion`),
  CONSTRAINT `fk_capacitacion_empleadoBodega` FOREIGN KEY (`idEmpleadoBodega`) REFERENCES `empleadoBodega` (`idEmpleadoBodega`)
